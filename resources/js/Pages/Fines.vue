<template>
    <app-layout-map content-width="w-10/12">
        <div class="fines">
            <div class="flex items-center justify-between pt-10 mb-4">
                ...
                <div class="flex items-center">
                    <button class="text-base text-yellow-400 flex items-center mr-12" @click="$modal.open('addFines')">
                        <icon name="plus" class="w-5 mr-3 block fill-current text-yellow-400"/>
                        Добавить штраф
                    </button>
                    <div class="flex">
                        <a href="#" class="text-base text-yellow-400 flex items-center px-5 border-r-2 border-gray-200">Штрафы</a>
                        <a href="/partners-remarks" class="text-base text-gray-200 flex items-center px-5">Замечание партнеров(12)</a>
                    </div>
                </div>
            </div>
            ...
            <fines-table v-if="this.fines"/>
            <partner-remarks-table v-if="!this.fines"/>
        ...
        <div slot="modals">
            <div class="modal">
                <modal class="confirmation" name="confirmation" close-text>
                    <div class="flex flex-col items-center px-10">
                        ...
                        <p class="text-base text-gray-900 flex flex-col items-center mb-4">
                            ...
                            <span class="leading-none">штраф?</span>
                        </p>
                    </div>
                    <div class="flex justify-between items-center px-5">
                        <button class="text-orange-400 text-base">Да</button>
                        <button class="text-orange-400 text-base" @click="$modal.close('confirmation')">Нет</button>
                    </div>
                </modal>
                ...
                <modal class="credit" name="addFines" close-text>
                    <div class="-mt-6">
                        ...
                        <div class="flex pb-4 mb-6">
                            <div class="w-1/3 pr-4 flex flex-col">
                                <div class="flex flex-col w-full">
                                    ...
                                    <v-date-picker v-model="creditTerm" mode="date" is-expanded  ref="datepicker">
                                        <template v-slot="{ inputValue, togglePopover }">
                            ...
                            <div class="w-1/3 px-2 flex flex-col">
                                <div class="flex flex-col w-full">
                                    <label class="text-gray-900 text-xl font-medium mb-3">Курьера</label>
                                    <multiselect v-model="selectedAccountNumber"
                            ...
                            <div class="w-1/3 pl-4 flex flex-col">
                                <label class="text-gray-900 text-xl font-medium mb-3">Сумма</label>
                                <input type="number"
                                        placeholder="Ввод"
                        ...
                        <div class="flex justify-between">
                            <div class="w-2/4 flex flex-col">
                                <label class="text-gray-900 text-xl font-medium mb-3">Причина штрафа</label>
                                <input type="text"
                                    placeholder="Ввод"
                                    class="px-3 py-2 rounded-lg border-2 border-gray-150 placeholder-gray-150 focus:ring-0
                                        focus:border-gray-150 focus:outline-none text-gray-900">
                            ...
                            <div class="flex items-end">
                                <button class="leading-tight py-3 bg-yellow-400 text-white rounded-md px-8" @click="$modal.close('addFines'), $modal.open('confirmation')">
                                    Добавить
                                </button>
                            </div>
                        </div>
